...
// PathFindingSimulator.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CPathFindingSimulatorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CPathFindingSimulatorApp

CPathFindingSimulatorApp::CPathFindingSimulatorApp()
{
...
// Le seul et unique objet CPathFindingSimulatorApp

CPathFindingSimulatorApp theApp;


// Initialisation de CPathFindingSimulatorApp

BOOL CPathFindingSimulatorApp::InitInstance()
{

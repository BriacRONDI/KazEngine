...
namespace Engine
{
	...
	*/
     ...
     */
    size_t Vulkan::SendToBuffer(DATA_BUFFER& buffer, const void* data, VkDeviceSize data_size, VkDeviceSize destination_offset)
    {
        ...
        std::memcpy(reinterpret_cast<char*>(this->staging_pointer) + destination_offset, data, data_size);
        ...
        vkCmdCopyBuffer(this->transfer_command_buffer.handle, this->staging_buffer.handle, buffer.handle, 1, &buffer_copy_info);
    ...
    */
    ...
    bool Vulkan::PresentImage(RENDERING_RESOURCES& rendering_resource,

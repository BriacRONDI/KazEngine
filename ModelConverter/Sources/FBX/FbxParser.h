...
#include <Engine/Common/Packer/Packer.h>
#include <Engine/Common/Maths/Maths.h>
#include <Engine/Graphics/Skeleton/Skeleton.h>
...
class FbxParser
{
    public :
        ...
        FbxParser(std::vector<char> const& data);
        std::vector<char> ParseData(std::string const& texture_directory = {});
    ...
    private :
        ...
        struct FBX_BONE {
            ...
            int64_t bone_id;
            std::string name;
            Engine::Matrix4x4 transform_link;
            Engine::Matrix4x4 transform;
            Engine::Matrix4x4 deformation;
            uint32_t link_mode;
        ...
        struct FBX_MESH_GEOMETRY {
            ...
            FBX_NODE model;
            Engine::Matrix4x4 global_transformation;
            Engine::Matrix4x4 local_transformation;
            FBX_BONE cluster;
        ...
        std::map<std::string, Engine::Mesh::MATERIAL> engine_materials;
        ...
        inline void SetTextColor(uint8_t color = TEXT_COLOR_NEUTRAL);
        ...
        Engine::Matrix4x4 ComputeTransformation(FBX_NODE const& node, std::vector<FBX_NODE> const& models);
        Engine::Matrix4x4 ComputeTransformation(FBX_NODE const& node, Engine::Matrix4x4 const& parent_transformation);
